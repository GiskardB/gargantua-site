  ...
  return (
    <section className="hero" data-screen-label="01 Hero">
      <div className="container">
        <div className="grid">
          <div>
            <div className="eyebrow reveal">Java 21 · Apache 2.0 · v1.0.0</div>
            <h1 className="reveal" style={{ marginTop: 20 }}>
              Build autonomous<br/>
              AI agents <em>in Java.</em>
            </h1>
            <p className="sub reveal">
              Gargantua is a distributable framework built on Spring Boot 4 and LangChain4j.
              ...
              Orchestration, routing, memory, guardrails, streaming, eval, cost tracking — all included.
            </p>
