...
function ClosingCTA() {
  ...
  const cmd = 'mvn archetype:generate -DarchetypeGroupId=ai.gargantua -DarchetypeArtifactId=agent-archetype';
  return (
    <section className="closing" data-screen-label="05 Closing">
      ...
      <div className="container reveal" style={{ position: 'relative' }}>
        ...
        <div className="install-row">
          ...
          <span style={{ color: 'var(--fg-mute)' }}>-DarchetypeGroupId=ai.gargantua</span>
    ...
    <nav className="top">
      <div className="container row">
        ...
        <ul>
          ...
          <li><a href="https://github.com/giskardb/gargantua">Docs</a></li>
        </ul>
...
function Footer() {
  return (
    <footer>
      <div className="container row">
        <div>© 2026 Gargantua — Apache 2.0</div>
