...
function ClosingCTA() {
  ...
  const cmd = 'mvn archetype:generate -DarchetypeGroupId=com.github.giskardb.gargantua -DarchetypeArtifactId=agent-archetype -DarchetypeVersion=v1.2.2 -DarchetypeRepository=https://jitpack.io';
  return (
    <section className="closing" data-screen-label="05 Closing">
      ...
      <div className="container reveal" style={{ position: 'relative' }}>
        ...
        <div className="install-row">
          ...
          <span style={{ color: 'var(--fg-mute)' }}>-DarchetypeVersion=v1.2.2</span>
        ...
        <div style={{ marginTop: 32, display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <a className="btn" href="#quickstart">Read the docs →</a>
        </div>
      </div>
    </section>
  );
    ...
    <nav className="top">
      <div className="container row">
        <a className="brand" href="#top">
          ...
          <span className="ver">v1.2.2</span>
        </a>
        <ul>
          <li><a href="#quickstart">Quick start</a></li>
          <li><a href="#architecture">Architecture</a></li>
          <li><a href="#features">Features</a></li>
          <li><a href="https://github.com/GiskardB/gargantua#documentation">Docs</a></li>
        </ul>
