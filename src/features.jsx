...
const FEATURES = [
  ...
  { k: '03', title: '3-layer memory',      desc: 'Working (Redis) for the live conversation, episodic (Mongo) for past sessions compressed via the routing model (same provider as primary, or point it at a free local Ollama model), knowledge (Mongo) for user facts.' },
